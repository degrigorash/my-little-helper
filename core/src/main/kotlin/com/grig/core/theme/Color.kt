...
val gradientBackgroundTopLight = Color(0xFFF0EDF5)
val gradientBackgroundBottomLight = Color(0xFFD4CCE0)
val headerTextLight = Color(0xFF3D2C5C)
val cardTextLight = Color(0xFFFFFFFF)
val malCardStartLight = Color(0xFF6A7BB5)
val malCardEndLight = Color(0xFF4A5A92)
val malIconContainerLight = Color(0xFF8B9BC8)
...
val malLoginGradientStartLight = Color(0xFF6B4FA2)
val malLoginGradientEndLight = Color(0xFF4338CA)
val malLoginOutlineLight = Color(0xFFB8B0C8)

// Extended palette — Dark
val gradientBackgroundTopDark = Color(0xFF1A1724)
val gradientBackgroundBottomDark = Color(0xFF2E2A38)
val headerTextDark = Color(0xFFE8E4F0)
val cardTextDark = Color(0xFFFFFFFF)
val malCardStartDark = Color(0xFF4A5A92)
val malCardEndDark = Color(0xFF2E3A62)
val malIconContainerDark = Color(0xFF5C6CA0)
...
val malLoginGradientStartDark = Color(0xFF5A3F8A)
val malLoginGradientEndDark = Color(0xFF352AAA)
val malLoginOutlineDark = Color(0xFF6E6880)
